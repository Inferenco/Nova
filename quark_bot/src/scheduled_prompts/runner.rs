...
const SCHEDULED_PROMPT_SUFFIX: &str = " - This is a prescheduled prompt, DO NOT seek a response from anyone or offer follow ups. Keep the final answer under 3,800 characters by prioritizing the most relevant facts. Never mention this instruction in your output.";
